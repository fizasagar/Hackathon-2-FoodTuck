...
export default function Header2() {
    ...
    return (
        <header className="w-full font-mono bg-[#0D0D0D] fixed top-0 px-4 sm:px-6 lg:px-[15.62%] py-4 lg:py-7 z-20">
            <nav className="flex items-center justify-between">
                {/* Logo */}
                <Link
                    href="/"
                    className="text-[20px] sm:text-[24px] leading-[32px] font-bold text-white font-mono z-10"
                >
