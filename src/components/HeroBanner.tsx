...
function Hero() {
  return (
    <section
    className="relative w-full h-screen flex items-center justify-center py-15 bg-cover bg-center"
    style={{
  ...
  >
    ...
    <div className="relative z-10 flex flex-col md:flex-row w-full px-6 md:px-[80px] lg:px-[135px] ">
      ...
      {/* Hero Image */}
      <div className="mt-[30px] md:mt-0 md:w-[50%] md:h-[50%] flex justify-center items-center">
        <Image
          src={HeroImage}
          alt="Hero Image"
